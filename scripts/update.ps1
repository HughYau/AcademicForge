...
try {
    ...
    try {
        ...
        Write-ColorOutput "WARNING: Could not update forge repository (might be on a detached HEAD)" "Yellow"
    }
}
...
try {
    ...
    Write-ColorOutput "ERROR: Some skills failed to update" "Red"
...
$gitStatus = git status --porcelain
if ($gitStatus) {
    Write-ColorOutput "WARNING: You have uncommitted changes after the update" "Yellow"
...
Write-ColorOutput "Update finished." "Green"
